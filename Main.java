...
public class Game extends Application {
	...
	public static void sound(String music){
		...
		music = ("file:/Users/max/RPG/res/" + music);
    ...
    Image Background = new Image("file:res/BackGround1216x768.png");
    Image sideBar = new Image("file:res/sideBar.png");
    Image Heart = new Image("file:res/heart64x64.png");
    Image Shield = new Image("file:res/heart64x642.png");

    //upgrade objects
    Objects bDamage = new Objects("file:res/bullet64x64.png", 64, 64, "Increases the number of enemies a bullet can go through.");
    Objects bSpeed = new Objects("file:res/speed64x64.png", 64, 64, "Increases the rate of which you shoot and the speed of you bullets.");
    Objects cHealth = new Objects("file:res/heart64x64.png", 64, 64, "Increases the players maximum health.");
    Objects cSpeed = new Objects("file:res/shoe64x64.png", 64, 64, "Increases the players movement speed.");
    Objects cShield = new Objects("file:res/heart64x642.png", 64, 64, "Gives you a shield that regenerates after not having taken damage for 5 seconds.");

    Objects Start = new Objects("file:res/StartScreen1280x800.png");
    Start.NewY(0);
    Start.NewX(0);

    Objects PauseScreen = new Objects("file:res/PauseScreen640x400.png");
    PauseScreen.NewY(200);
    PauseScreen.NewX(320);

    Objects StatsScreen = new Objects("file:res/StatsGUI800x500.png");
    StatsScreen.NewY(150);
    StatsScreen.NewX(240);

    Objects Shop = new Objects("file:res/ShopGUI800x500.png");
    Shop.NewY(150);
    Shop.NewX(240);
